...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href="resume.php">About</a></li>
	...
	<div class="container">
		<div class="row centered mt mb">
			<div class="col-lg-8 col-lg-offset-2">
				...
				<div id="textbox">
					<p class="alignleft">M.A. in Education, <em>Concentration in Instructional Technology</em></p>
					<p class="alignright">August 2015 - Present</p>
				</div>
				<div style="clear: both;"></div>
				<div id="textbox">
					<p class="alignleft">B.A. in Economics</p>
					<p class="alignright">May 2014 - August 2015</p>
				</div>
				<div style="clear: both;"></div>
				<p><strong>The University of Houston</strong></p>
				<p><em><strong>Houston, Texas</strong> </em></p>
				<div id="textbox">
					<p class="alignleft">Computer Science</p>
					<p class="alignright">August 2012 - May 2014</p>
				</div>
				<div style="clear: both;"></div>

				<h2>Work Experience</h2><hr>
				<div id="textbox">
					<p class="alignleft"><strong>Lead Inventory</strong></p>
					<p class="alignright">August 2014 - July 2016</p>
				</div>
				<div style="clear: both;"></div>
				...
				<div id="textbox">
					<p class="alignleft"><strong>Guest Services Representative</strong></p>
					<p class="alignright">September 2011 - August 2012</p>
				</div>
				<div style="clear: both;"></div>
				...
				<div id="textbox">
					<p class="alignleft"><strong>Power Supply Unit Tester Intern</strong></p>
					<p class="alignright">April 2011 - August 2011</p>
				</div>
				<div style="clear: both;"></div>
				...
				<div id="textbox">
					<p class="alignleft"><strong>Dean's List</strong></p>
					<p class="alignright">Summer 2014</p>
				</div>
				<div style="clear: both;"></div>
				<p class="recog"><em>University of Texas at San Antonio, San Antonio, Texas</em></p>
				<div id="textbox">
					<p class="alignleft"><strong>Store Champion (Employee of the Month)</strong></p>
					<p class="alignright">April 2015, February 2016</p>
				</div>
				<div style="clear: both;"></div>
	...
	<script src="/js/bootstrap.js" integrity="sha384-0mSbJDEHialfmuBBQP6A4Qrprq5OVfW37PRR3j5ELqxss1yVqOtnepnHVP9aJ7xS" crossorigin="anonymous"></script>
  </body>
</html>
